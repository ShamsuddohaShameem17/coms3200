"""
@file    assign2.py
@author  Shamsuddoha Shameem s4398066
@date    30/04/2019
@brief   RUSH UDP packet (server code)
@Reference a2.pdf (COMS3200)
    usage: python3 assign2.py
"""
...
RECV_SIZE = 1500 #Max_Packet size
TIMEOUT = 3
DEBUG = 1
...
class Connection:
    ...
    def recv_pkt(self):
        while True:
            try:
                ...
                try:
                    return raw_packet_decode(raw_data)
                except:
                ...
                return "timed out" # Server will ignore it
        pass   
    ...
    def run(self):
        reading_pos = 0
        #Set default client ack and seq num
        self._client_seq = 1
        self._client_ack = 0
            ...
            if(pkt == "timed out"):
                ...
                #ignore
                    ...
                    # Handle dat-ack     
                        ...
                        if(self._client_ack+1==pkt.ack_num and self._client_seq+1==pkt.seq_num):
                            self._client_ack+=1
                            self._client_seq+=1
                            reading_pos +=1
                            self._seq_num+=1
