#Create socket (RAW) packets for UDP
#IMPORTS
import socket
import struct
...
#Encode data into an UDP packet
def parse(data):
    packet = {}
...
#Send data (encoded) to local host/another process
def udp_send(data, dest_addr, src_addr=('127.0.0.1', 35869)):
    ...
    checksum = 0 #16bit 1's complement
...
#Calculate One's complement of 16 bit binary
...
#Verify checksum recieved to calculated checksum
